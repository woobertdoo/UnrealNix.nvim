...
function Stage_UbtGenCmd()
	...
	local old_text = "Llvm\\\\x64\\\\bin\\\\clang%-cl%"
	local new_text = "Llvm/x64/bin/clang++"
...
function InitializeCurrentGenData()
	...
	CurrentGenData.ueBuildScript = '"' .. CurrentGenData.config.EngineDir .. '/Engine/Build/BatchFiles/Linux/Build.sh"'
...
function Commands.BuildCoroutine()
	...
	local cmd = CurrentGenData.ueBuildScript
		.. " "
		.. CurrentGenData.prjName
		.. CurrentGenData.targetNameSuffix
		.. " "
